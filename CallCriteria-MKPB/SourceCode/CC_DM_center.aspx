<%@ Page Title="" Language="VB" MasterPageFile="~/CC_Master.master" AutoEventWireup="false" CodeFile="CC_DM_center.aspx.vb" Inherits="CC_DM_center" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="main-container dash-modules general-button">
        <h2>David Marshall Call Center Stats</h2>
         From:
        ...
        <asp:SqlDataSource ID="dsSummary" runat="server" ConnectionString="<%$ ConnectionStrings:estomesManual %>"
            ...
            where review_date between dateadd(hh,-14,@start) and dateadd(hh, -14, dateadd(d,1,@end)) 
            and call_center = 2 group by vwForm.reviewer">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="dsTrain" runat="server" ConnectionString="<%$ ConnectionStrings:estomesManual %>"
            ...
            join userextrainfo on reviewer = username where review_date between dateadd(hh,-14,@start) and dateadd(hh, -14, dateadd(d,1,@end)) and call_center = 2 group by reviewer">
            <SelectParameters>
                <asp:ControlParameter ControlID="date_from" Name="start" PropertyName="Text" />
                <asp:ControlParameter ControlID="date_to" Name="end" PropertyName="Text" />
            </SelectParameters>
