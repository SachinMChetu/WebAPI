<%@ Page Title="" Language="VB" MasterPageFile="~/CCMasterPage.master" AutoEventWireup="false" EnableEventValidation="false"
    CodeFile="Admin_Dashboard.aspx.vb" Inherits="Admin_Dashboard" %>
                                ...
                                <asp:Repeater ID="rptMissed" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="expandedview.aspx?filter= and fs.id in(select * from dbo.GetFormListByShortName('<%#Eval("q_short_name") %>','<%=Session("appname")%>'))"><%#Eval("q_short_name") %></a>
                                            </td>
                        ...
                        <div class="table-outline">
                            <asp:GridView ID="gvQADetails" GridLines="None" CssClass="invisible-frame" runat="server" DataSourceID="dsQADetails" AllowPaging="true" AllowSorting="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="missed_list" SortExpression="total_score" HeaderText="Missed Items" />
