<%@ Page Title="Listen" Language="VB" MasterPageFile="~/CC_Master.master" AutoEventWireup="false" ValidateRequest="false" CodeFile="listen_vb.aspx.vb" Inherits="listen3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/whisper2.js?1005"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="main-container">
        ...
        <asp:HiddenField ID="hdnSubmitTime" runat="server" />
                                        ...
                                        <div class="<%#eval("show_pin") %>" data-qid="<%#Eval("question_id")%>" data-ansorder="<%#Eval("ans_order")%>" data-anstype="<%#Eval("div_class")%>" data-pinans="<%#Eval("ID")%>">
                                            ...
                                            <div class="pin-options-select">
                                                ...
                                                <asp:SqlDataSource ID="dsResponseOptions" runat="server" ConnectionString="<%$ ConnectionStrings:estomes2ConnectionString %>"
                                                    SelectCommand="SELECT * FROM [answer_comments] with (nolock) where answer_id = @ANS_ID">
                                                    <SelectParameters>
        ...
        <div class="listen-end-buttons">
            ...
            <div class="bad-call-buttons">
                ...
                <asp:TextBox ID="txtOtherReason" MaxLength="100" runat="server"></asp:TextBox>
