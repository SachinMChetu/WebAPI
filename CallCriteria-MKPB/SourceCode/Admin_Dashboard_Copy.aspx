<%@ Page Title="" Language="VB" MasterPageFile="~/CC_Master.master" AutoEventWireup="false" EnableEventValidation="false"
    CodeFile="Admin_Dashboard_Copy.aspx.vb" Inherits="Admin_Dashboard" %>
        ...
        <div class="panel">
            ...
            <div class="line-graph-container">
                <div class="line_graph">
                    ...
                    <div runat="server" id="slider_div"></div>
                    ...
                    <script>
                        $(function () {
                            $('#ContentPlaceHolder1_slider_div').slider({
                                ...
                                min: <%=min_line_range%>,
                                max: <%=max_line_range%>,
                                values: [<%=min_line_range%>, <%=max_line_range%>],
                                slide: function (event, ui) {
                                    ...
                                    //alert (ui.values[0]);
                                    //alert (ui.values[1]);
                                    options.hAxis.viewWindow.min = ui.values[0];
                                    options.hAxis.viewWindow.max = ui.values[1];
                                    chart.draw(data, options);
                            ...
                            var start_date = new Date();
                            start_date.setDate(start_date.dbo.getMTDate() + <%=min_line_range%>);
                            var dateStart = (start_date.getMonth() + 1) + '/' + start_date.dbo.getMTDate() + '/' + start_date.getFullYear();


                            var end_date = new Date();
                            end_date.setDate(end_date.dbo.getMTDate()) + <%=max_line_range%>;
                            var dateEnd = (end_date.getMonth() + 1) + '/' + end_date.dbo.getMTDate() + '/' + end_date.getFullYear();
