<%@ Page Title="Calibration Listen" Language="VB" MasterPageFile="~/CC_Master.master" AutoEventWireup="false" ValidateRequest="false" CodeFile="calibrate_listen.aspx.vb" Inherits="listen3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/whisper2.js?1004"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="main-container">
        ...
        <asp:HiddenField ID="hdnisrecal" runat="server" />
                    ...
                    <asp:Repeater ID="DataList1" DataSourceID="dsQuestions"
                        ...
                        <ItemTemplate>
                            ...
                            <div class="pin-box  <%#Eval("has_options")%>  " data-pb-qid='<%# Eval("ID")%>'  data-pb-lq='<%# Eval("linked_question")%>' data-pb-la='<%# Eval("linked_answer")%>' 
                                ...
                                <span class="pin-name"><%# Eval("q_short")%><asp:RequiredFieldValidator ID="RequiredFieldValidator1" SetFocusOnError="true" ForeColor="Red" ControlToValidate="hdnWasChosen" runat="server" Text="*">
                            ...
                            <div class="pin-options <%#Eval("has_options")%>">
                                ...
                                <asp:Repeater ID="rptAnswers" runat="server" OnItemDataBound="rptAnswers_ItemDataBound" DataSourceID="dsAnswers">
                                    <ItemTemplate>
                                        ...
                                        <div class="<%#eval("show_pin") %>" data-qid="<%#Eval("question_id")%>" data-ansorder="<%#Eval("ans_order")%>" data-anstype="<%#Eval("div_class")%>" data-pinans="<%#Eval("ID")%>">
                                            ...
                                            <div class="pin-options-select">
                                                ...
                                                <asp:TextBox ID="txtOtherComment" TextMode="MultiLine" runat="server"></asp:TextBox><br />
                                    ...
                                    <FooterTemplate>
                                        <span>
                                            <span>
                                                ...
                                                <asp:TextBox ID="txtOtherList" TextMode="MultiLine" runat="server" Style="position: relative; top: 10px;"></asp:TextBox><br />
                                                <asp:CheckBox ID="chkWebsite" runat="server" />
                                                <asp:TextBox ID="txtWebsiteLink" CssClass="offset-listen-textbox" placeholder="Website...." TextMode="MultiLine" runat="server"></asp:TextBox>
                                            </span></span>
                                        <div class="pin-options-select">
        ...
        <div class="listen-end-buttons">
            ...
            <%-- <div class="bad-call-buttons">
                ...
                <asp:DropDownList ID="ddlDropReason" runat="server">
                    ...
                    <asp:ListItem>*Call transfers/OBWT eStomes</asp:ListItem>
                ...
                <asp:Button ID="btnBadCall" runat="server" Text="Bad Call" CausesValidation="false" CssClass="gradient" />
            </div>
