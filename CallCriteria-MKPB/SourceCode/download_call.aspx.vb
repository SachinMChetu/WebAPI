...
Partial Class download_call
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        dsAllQs.SelectParameters("username").DefaultValue = User.Identity.Name
    ...
    Private Sub gvAllQs_DataBound(sender As Object, e As EventArgs) Handles gvAllQs.DataBound
        Try
        ...
        End Try
    End Sub
    ' http://app.callcriteria-dev.com/download_call2.aspx?ID=2995274
    Private Sub gvAllQs_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvAllQs.RowDataBound
        ...
        Try
            ...
            For x = 4 To e.Row.Cells.Count - 1
                e.Row.Cells(x).HorizontalAlign = HorizontalAlign.Center
            Next
