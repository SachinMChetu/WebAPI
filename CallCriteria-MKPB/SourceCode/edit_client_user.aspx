<%@ Page Title="" Language="VB" MasterPageFile="~/CC_Master.master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="edit_client_user.aspx.vb" Inherits="edit_client_user" %>
                            ...
                            <td valign="top">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <asp:GridView ID="gvUserGroups" DataKeyNames="ID" DataSourceID="dsGroups" runat="server">
                                            <Columns>
                                        ...
                                        <asp:SqlDataSource ID="dsGroups" SelectCommand="getUserGroups" SelectCommandType="StoredProcedure"
                                            ...
                                            UpdateCommand ="update user_groups set userGroup = @userGroup where id = @id "
                                        ...
                                        <asp:Button ID="btnSCGroupAdd" runat="server" Text="Add" />
