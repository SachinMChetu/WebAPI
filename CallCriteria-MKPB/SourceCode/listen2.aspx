<%@ Page Title="" Language="VB" MasterPageFile="~/CC_Master.master" AutoEventWireup="false" CodeFile="listen2.aspx.vb" Inherits="listen" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        //function checkAuto() {
        //    if (document.getElementById('ContentPlaceHolder1_hdnAutoSubmit').value == "True") {
        //        if (Page_ClientValidate('ValidationGroup')) {
        //            WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("ctl00$ContentPlaceHolder1$btnSaveSession", "", true, "", "", false, false));
        //        }
        //    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="main-container listening-actions right-sidebar-showed">
        <h3>Call from <asp:Label runat="server" ID="lblThisApp"></asp:Label></h3>
        ...
        <div class="listenint-section">
            ...
            <div class="actions-in-right listening-main-actions">
                ...
                <br /><br />
                If this call is bad, select the reason, and click Bad Call.<br />
                <asp:DropDownList ID="ddlDropReason" runat="server">
                    ...
                    <asp:ListItem>*Callback Request</asp:ListItem>
                    <asp:ListItem>*Not Interested</asp:ListItem>
                    <asp:ListItem>Other</asp:ListItem>
                </asp:DropDownList> <asp:Button ID="btnBadCall" CausesValidation="false" CssClass="main-cta close-popup" runat="server" Text="Bad Call" />
                <br /><br /><br /><br />&nbsp;<br />
            </div>
