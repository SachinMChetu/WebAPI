...
namespace WebApi.Entities
{
    ...
    public partial class calibration_pending
    {
        ...
        public Nullable<System.DateTime> client_review_completed { get; set; }
        public Nullable<int> sc_id { get; set; }
        public Nullable<int> isRecal { get; set; }
        public string calibrator_assigned { get; set; }
        public Nullable<bool> callcenter_review { get; set; }
        public string cp_who_added { get; set; }
        public string client_who_closed { get; set; }
    }
}
