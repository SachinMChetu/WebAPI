...
namespace WebApi.Entities
{
    ...
    public partial class CC_ProdEntities : DbContext
    {
        ...
        public virtual int getSpotCheckData(Nullable<System.DateTime> start, Nullable<System.DateTime> end, Nullable<int> scorecard, string appname, string tl)
        {
            var startParameter = start.HasValue ?
                new ObjectParameter("start", start) :
            ...
            var tlParameter = tl != null ?
                new ObjectParameter("tl", tl) :
                new ObjectParameter("tl", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("getSpotCheckData", startParameter, endParameter, scorecardParameter, appnameParameter, tlParameter);
        }
    
        public virtual ObjectResult<GetActionButtonsData_Result> GetActionButtonsData(Nullable<int> f_id)
        {
            var f_idParameter = f_id.HasValue ?
                new ObjectParameter("f_id", f_id) :
                new ObjectParameter("f_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetActionButtonsData_Result>("GetActionButtonsData", f_idParameter);
        }
    
        public virtual ObjectResult<getClientCalibrations_Result> getClientCalibrations(string username, Nullable<int> show_completed, Nullable<int> scorecardId)
        {
            var usernameParameter = username != null ?
                new ObjectParameter("username", username) :
                new ObjectParameter("username", typeof(string));
    
            var show_completedParameter = show_completed.HasValue ?
                new ObjectParameter("show_completed", show_completed) :
                new ObjectParameter("show_completed", typeof(int));
    
            var scorecardIdParameter = scorecardId.HasValue ?
                new ObjectParameter("scorecardId", scorecardId) :
                new ObjectParameter("scorecardId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getClientCalibrations_Result>("getClientCalibrations", usernameParameter, show_completedParameter, scorecardIdParameter);
        }
    
        public virtual ObjectResult<GetAudioFiles_Result> GetAudioFiles(Nullable<int> x_id)
        {
            var x_idParameter = x_id.HasValue ?
                new ObjectParameter("x_id", x_id) :
                new ObjectParameter("x_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAudioFiles_Result>("GetAudioFiles", x_idParameter);
        }
    
        public virtual ObjectResult<Getnotification_steps_Result> Getnotification_steps(string myRole, Nullable<int> form_id)
        {
            var myRoleParameter = myRole != null ?
                new ObjectParameter("myRole", myRole) :
                new ObjectParameter("myRole", typeof(string));
    
            var form_idParameter = form_id.HasValue ?
                new ObjectParameter("form_id", form_id) :
                new ObjectParameter("form_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Getnotification_steps_Result>("Getnotification_steps", myRoleParameter, form_idParameter);
        }
    
        public virtual int getNotificationStatus(string start_date, string end_date, string filter, string filterarray)
        {
        ...
        public virtual ObjectResult<GetAudioFileName_Result> GetAudioFileName(string userName, Nullable<int> id)
        {
            var userNameParameter = userName != null ?
                new ObjectParameter("userName", userName) :
                new ObjectParameter("userName", typeof(string));
